...
const ACCENT = '#22C55E'; // matches globals.css --color-primary — was drifted to #1EAF53
const ACCENT_DARK = '#16A34A'; // matches globals.css --color-primary-dark — was drifted to #178842
